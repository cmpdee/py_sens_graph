####### originally from https://www.digikey.com/en/maker/projects/python-gui-guide-introduction-to-tkinter/d04a764c78114682aac9255056026338
...
def animate(i, ax1, ax2, xs, temps, lights, temp_c, lux):
    ...
    try:
        ...
        new_temp = rnd.randint(15,20)
        new_lux = rnd.randint(5,50)
    except:
        pass
...
# ??? Function flipping 1 plot in 2 plots
def graph_flip():
    pass
...
button_graph.grid(row=5, column=3, columnspan=2)
